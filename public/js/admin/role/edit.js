$(document).ready(function(){
  ...
  $('#main-form').submit(function(){
        ...
        $('#ajax-icon').removeClass('fas fa-edit').addClass('spinner-border spinner-border-sm');
            ...
            $.ajax({
              ...
              cache: false,
               ...
               success: function (response) {
                ...
                $('#ajax-icon').removeClass('spinner-border spinner-border-sm').addClass('fas fa-save');
              }
           });
        });
